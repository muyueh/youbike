...
var ref$, each, listsToObj, ggl, datalist, gglstationsTsv, cw, ch, hdata, wdata, data, color, svg, buildHeatMap, parse, run, wait, w, h, mapOffset, styleName, zoomLevel, colorscheme, wtbl, flash;
...
buildHeatMap = function(data, colorscheme, name){
  var rg, color;
  rg = colorscheme === "YlOrRd" ? 4000 : 30000;
  ...
  svg.selectAll("heatreact").data(data).enter().append("rect").attr({
    "x": function(it, i){
      return (colorscheme === "YlOrRd"
        ? 0
        : ggl.rect_width / 2) + it.hour * (ggl.rect_width + ggl.rect_margin);
    },
    "y": function(it, i){
