...
var ref$, each, listsToObj, take, drop, reverse, ggl, datalist, gglstationsTsv, cw, ch, crg, hdata, wdata, data, autoplay, colorscheme, lsColorRed, lsColorBlue, focusIdx, mpw, mph, mapOffset, styleName, zoomLevel, wtbl, dur;
...
autoplay = false;
colorscheme = "RdYlBu";
lsColorRed = reverse(take(5, colorbrewer[colorscheme][9]));
lsColorBlue = drop(4, colorbrewer[colorscheme][9]);
focusIdx = null;
mpw = 1200;
mph = 700;
mapOffset = 4000;
