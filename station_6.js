...
var ref$, each, listsToObj, ggl, datalist, gglstationsTsv, cw, ch, hdata, wdata, data, color, svg, buildHeatMap, parse, run, lsfl, wait, flokay, w, h, mapOffset, styleName, zoomLevel, colorscheme, wtbl, flash, overlayGoog;
