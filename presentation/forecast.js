...
var ref$, listsToObj, flatten, ggl, setColorScl, whtick, setVCircleColor, hhdr, hmap, hs, initStInfo, initDiv;
...
initDiv = function(){
  var appndDiv;
  appndDiv = d3.selectAll(".lsstn").selectAll(".stn").data([0, 1, 2, 3, 4, 5]).enter().append("div").attr({
    "class": function(it, i){
      return "stn stn" + i;
    }
  });
      ...
      return d3.tsv("../move_week _hour/" + flname + ".tsv", function(err, whdata){
        ...
        return whdata.map(function(stdata){
          ...
          if (flwait === 0 && whwait === 0) {
            ...
            return initStInfo(".stn4", "捷運大安森林公園站");
          }
        });
      });
    });
